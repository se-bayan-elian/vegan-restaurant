export  const VEGAN_INFO = {
    ...
    boxes: [
      {
        img: '',
        title: 'Fresh food',
        desription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sollicitudin hendrerit a amet viverra. Nunc pretium in amet at mattis cras. '
      },
      {
        img: '',
        title: 'skilled Chef',
  ...
  'reviews': {
    title: 'words from our food lovers',
    elements:
      [
        {
          id: '1',
    ...
    elements: [
      {
        id: '1',
        img: '',
        name: 'Cooking Dining Experience',
        desscription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sollicitudin '
      },
      {
        id: '2',
        img: '',
  ...
  'contactUs': {
    hyperLinks: ['Privacy Policy', 'Terms & conditions', 'Blogs', 'our team', 'Our kitchen'],
    contactInfo: [
      {
        id: '1',
        name: 'email',
        value: 'Gogreendineservice@gmail.com',
        icon: ''
      },
      {
        id: '2',
        name: 'address',
        value: 'AZ complex bylane3 Mandari RdMumbai 1100867',
        icon: ''
      },
      {
        id: '3',
